...
export default class EthereumFlow {
     ...
     */
    execute<ChannelT extends import("./channel/Channel.js").default, MirrorChannelT>(client: import("./client/Client.js").default<ChannelT, MirrorChannelT>): Promise<TransactionResponse>;
}
