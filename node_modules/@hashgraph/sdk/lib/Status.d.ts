...
declare namespace Status {
    ...
    const ProxyAccountIdFieldIsDeprecated: Status;
    const SelfStakingIsNotAllowed: Status;
    const InvalidStakingId: Status;
    const StakingNotEnabled: Status;
    const InvalidPrngRange: Status;
    const MaxEntitiesInPriceRegimeHaveBeenCreated: Status;
    const InvalidFullPrefixSignatureForPrecompile: Status;
}
